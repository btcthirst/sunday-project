...
// Stats moved to DashboardHome, removed from here

// Sync menu with route
// Sync menu with route
watch(() => route.path, (path) => {
  if (path.includes('/citizens')) {
    activeMenu.value = 'citizens'
  } else if (path.includes('/dashboard')) {
    if (path.includes('/registrations')) activeMenu.value = 'registrations'
    else if (path.includes('/audit')) activeMenu.value = 'audit'
    else if (path.includes('/help')) activeMenu.value = 'help'
...
const currentPageTitle = computed(() => {
  if (route.path.includes('/citizens')) return 'Громадяни'
  // Add other mappings
