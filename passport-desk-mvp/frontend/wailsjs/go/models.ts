export namespace models {
	...
	export class FamilyRelationInput {
	    ...
	    static createFrom(source: any = {}) {
	        return new FamilyRelationInput(source);
	    }
	...
	export class CitizenInput {
	    ...
	    email: string;
	    notes: string;
	    family_relations: FamilyRelationInput[];
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.family_relations = this.convertValues(source["family_relations"], FamilyRelationInput);
	    }
	...
	export class FamilyCertificateOptions {
	    citizen_ids: number[];
	    issuer_name: string;
	    ...
	    static createFrom(source: any = {}) {
	        return new FamilyCertificateOptions(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.citizen_ids = source["citizen_ids"];
	        this.issuer_name = source["issuer_name"];
	        this.target_institution = source["target_institution"];
	        this.purpose = source["purpose"];
	        this.signatory_title = source["signatory_title"];
	        this.signatory_name = source["signatory_name"];
	        this.city = source["city"];
	    }
	}
	export class FamilyMemberOutput {
	    id: number;
	    last_name: string;
	    first_name: string;
	    middle_name: string;
	    ...
	    static createFrom(source: any = {}) {
	        return new FamilyMemberOutput(source);
	    }
	...
	export class RegistrationListItem {
	    ...
	    updated_at: any;
	    citizen_name: string;
	    citizen_birth: string;
	    citizen_phone: string;
	    citizen_tax: string;
	
	    static createFrom(source: any = {}) {
	        return new RegistrationListItem(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.created_at = this.convertValues(source["created_at"], null);
	        this.updated_at = this.convertValues(source["updated_at"], null);
	        this.citizen_name = source["citizen_name"];
	        this.citizen_birth = source["citizen_birth"];
	        this.citizen_phone = source["citizen_phone"];
	        this.citizen_tax = source["citizen_tax"];
	    }
	...
	export class RegistrationListResult {
	    ...
	    static createFrom(source: any = {}) {
	        return new RegistrationListResult(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.items = this.convertValues(source["items"], RegistrationListItem);
	        this.total = source["total"];
	        this.page = source["page"];
	        this.limit = source["limit"];
	        this.total_pages = source["total_pages"];
